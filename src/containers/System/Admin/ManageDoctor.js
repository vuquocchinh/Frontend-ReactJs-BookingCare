...
class ManageUserDoctor extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    handleChangeSelect = async (selectedOption) => {
        ...
        // console.log("check on change co thong tin:", res);
    ...
    handleChangeSelectDoctorInfor = async (selectedOption, name) => {
        console.log("nameqqqq:", selectedOption);
    ...
    render() {
        let { hasOldData } = this.state;
        console.log("check state1222 : ", this.state);
        return (
            <>
...
const mapDispatchToProps = (dispatch) => {
    return {
        ...
        getAllRequiredDoctorInfor: () =>
            dispatch(action.getRequiredDoctorInfor()),
    };
};

export default connect(mapStateToProps, mapDispatchToProps)(ManageUserDoctor);
